...
A .NET library for building plugin-based architectures through configuration-driven module loading. Dynamically swap
infrastructure and resolve dependencies at startup via app settings, maintaining strict clean architecture boundaries
